...
export function NewExpenseForm({ onClose, onCreated }: Props) {
  ...
  return (
    <form
      ...
      className="space-y-4 text-whitemax-h-[100dvh]"
    >
          ...
          <div>
            ...
            <Select value={metodoPagamento} onValueChange={setMetodoPagamento}>
              ...
              <SelectContent>
                ...
                <SelectItem value="cartao de debito">
                  Cartão de Débito
                </SelectItem>
      ...
      {/* Botões */}
      <div className="sticky bottom-0 left-0 right-0 mt-4 bg-[var(--background)]/95 backdrop-blur border-t border-[color:var(--card-border)] pt-3 pb-[max(env(safe-area-inset-bottom),0.75rem)]">
